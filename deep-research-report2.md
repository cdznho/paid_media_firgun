...
```mermaid
gantt
  title May 2026 LP trial (assume 2026-05-01 start; $6k total)
  dateFormat  YYYY-MM-DD
  axisFormat  %d %b

  section Foundations (must be ready by launch)
  LP landing + eligibility gate build (TBC)       :a1, 2026-05-01, 10d
  GA4/GTM + consent mode QA                       :a2, 2026-05-01, 10d
  LinkedIn UK verification check (if UK targeted) :a3, 2026-05-01, 14d

  section Launch
  LinkedIn ABM pilot (company lists + seniority)  :b1, 2026-05-08, 24d
  Google Search brand + LP-intent pilot           :b2, 2026-05-08, 24d
  Retargeting pilot (LinkedIn + GDN)              :b3, 2026-05-12, 20d
  YouTube credibility micro-test                  :b4, 2026-05-15, 17d

  section Learn and decide
  Week-3 optimisation sprint                      :c1, 2026-05-22, 10d
  End-of-month review (CPL, meetings, compliance) :c2, 2026-05-30, 3d
```
...
```mermaid
gantt
  title Sep–Nov 2026 LP push (assume 2026-09-15 to 2026-11-15; $30k total)
  dateFormat  YYYY-MM-DD
  axisFormat  %d %b

  section Pre-push (prep)
  ABM target list refresh (accounts + roles)     :p1, 2026-09-15, 7d
  Creative refresh + compliance review (TBC)     :p2, 2026-09-15, 10d

  section Always-on core
  LinkedIn ABM scale (coverage + lead gen)       :c1, 2026-09-22, 55d
  Programmatic ABM pilot → scale                 :c2, 2026-09-29, 48d
  YouTube credibility flight + retargeting       :c3, 2026-09-29, 48d
  Search brand defence (always-on)               :c4, 2026-09-22, 55d

  section Sponsorships and events
  Podcast sponsorship test (vanity URL)          :s1, 2026-10-06, 28d
  Event amplification bursts (as scheduled)      :s2, 2026-10-10, 30d

  section Measurement upgrade
  Offline conversion import: qualified LP lead   :m1, 2026-10-01, 14d
  Offline conversion import: meeting held        :m2, 2026-10-15, 14d

  section Closeout
  Final optimisation sprint + budget reallocation: r1, 2026-11-01, 14d
  Post-window review + scale plan (TBC budget)   :r2, 2026-11-14, 2d
```
